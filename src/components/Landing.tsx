  ...
  return (
    <div className="flex items-center justify-center gap-8 h-80 md:h-64 flex-col md:flex-row mt-4 md:mt-0 w-full">
      ...
      <div>
        ...
        <Link
          href="/about"
          className="bg-slate-800 ml-4 text-center no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block my-4"
        >
